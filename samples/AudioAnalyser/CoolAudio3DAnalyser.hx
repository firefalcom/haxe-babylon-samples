...
class CoolAudio3DAnalyser extends Launcher {
    ...
    function createRingcubes(r, nb, scene) {
        ...
        for ( i in 0...nb) {
            if (i == 0) {
                ...
                bar[i] = cast bar[0].createInstance("b" + i);
    ...
    public override function createScene() {
        ...
        var music = new BABYLON.Sound("Music", "cosmosis.mp3",
