...
var Lines = function(width,height) {
...
Lines.__super__ = Launcher;
Lines.prototype = $extend(Launcher.prototype,{
	createScene: function() {
		...
		scene.registerBeforeRender(function() {
			...
			while(_g1 < 1000) {
				var index1 = _g1++;
				positionData[index1 * 3 + 1] = heightRange * Math.sin(alpha + index1 * 0.1);
			}
