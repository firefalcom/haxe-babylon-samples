...
Math.__name__ = true;
var PBRGlossy = function(width,height) {
	Launcher.call(this,width,height);
};
PBRGlossy.__name__ = true;
PBRGlossy.main = function() {
	new PBRGlossy();
};
PBRGlossy.__super__ = Launcher;
PBRGlossy.prototype = $extend(Launcher.prototype,{
	createScene: function() {
		...
		BABYLON.SceneLoader.Append("../../assets/DamagedHelmet/glTF/","DamagedHelmet.gltf",scene,function(scene1) {
			...
			var optimizer = new BABYLON.SceneOptimizer(scene1,options);
			optimizer.start();
			optimizer.onNewOptimizationAppliedObservable.add(function(optim,state) {
				console.log(optim.getDescription());
			});
			optimizer.onSuccessObservable.add(function(optimizer1,state1) {
