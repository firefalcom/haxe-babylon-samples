...
var AdvancedShadows = function(width,height) {
	Launcher.call(this,width,height);
};
AdvancedShadows.__name__ = true;
AdvancedShadows.main = function() {
	new AdvancedShadows();
};
AdvancedShadows.__super__ = Launcher;
AdvancedShadows.prototype = $extend(Launcher.prototype,{
	createScene: function() {
