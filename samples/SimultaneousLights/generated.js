...
Math.__name__ = true;
var SimultaneousLights = function(width,height) {
	Launcher.call(this,width,height);
};
SimultaneousLights.__name__ = true;
SimultaneousLights.main = function() {
	new SimultaneousLights();
};
SimultaneousLights.__super__ = Launcher;
SimultaneousLights.prototype = $extend(Launcher.prototype,{
	createScene: function() {
		...
		var _material1 = new BABYLON.StandardMaterial("green",scene);
		_material1.diffuseColor = new BABYLON.Color3(0,0,0);
		_material1.specularColor = new BABYLON.Color3(0,0,0);
		_material1.emissiveColor = new BABYLON.Color3(0,1,0);
		lightSphere1.material = _material1;
		var _material2 = new BABYLON.StandardMaterial("blue",scene);
		_material2.diffuseColor = new BABYLON.Color3(0,0,0);
		_material2.specularColor = new BABYLON.Color3(0,0,0);
		_material2.emissiveColor = new BABYLON.Color3(0,0,1);
		lightSphere2.material = _material2;
