...
Math.__name__ = true;
var StandardRenderingPipelineSample = function(width,height) {
	Launcher.call(this,width,height);
};
StandardRenderingPipelineSample.__name__ = true;
StandardRenderingPipelineSample.main = function() {
	new StandardRenderingPipelineSample();
};
StandardRenderingPipelineSample.__super__ = Launcher;
StandardRenderingPipelineSample.prototype = $extend(Launcher.prototype,{
	createScene: function() {
	...
	,__class__: StandardRenderingPipelineSample
});
var Std = function() { };
Std.__name__ = true;
...
StandardRenderingPipelineSample.main();
