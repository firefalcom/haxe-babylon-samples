class Sprites extends Launcher {
    ...
    private override function createScene() {
        ...
        var spriteManagerTrees = new BABYLON.SpriteManager("treesManager", "palm.png", 2000, 800, scene);
        ...
        var spriteManagerPlayer = new BABYLON.SpriteManager("playerManager", "player.png", 2, 64, scene);
        ...
        scene.onPointerDown = function(evt, p, t) {
            var pickResult = scene.pickSprite(evt.clientX, evt.clientY);
            if(pickResult.hit) {
