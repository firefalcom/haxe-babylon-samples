...
Math.__name__ = true;
var Sprites = function(width,height) {
	Launcher.call(this,width,height);
};
Sprites.__name__ = true;
Sprites.main = function() {
	new Sprites();
};
Sprites.__super__ = Launcher;
Sprites.prototype = $extend(Launcher.prototype,{
	createScene: function() {
		...
		while(_g < 2000) {
			...
			tree.position.x = tmp - 50;
			var tmp1 = Math.random() * 100;
			tree.position.z = tmp1 - 50;
